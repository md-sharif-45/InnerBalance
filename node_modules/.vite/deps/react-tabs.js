    ...
    return deepMap(children2, (child) => {
      ...
      if (isTabList(child)) {
        ...
        result = (0, import_react2.cloneElement)(child, { children: deepMap(child.props.children, (tab) => {
          ...
          if (selectedTabClassName2) props2.selectedClassName = selectedTabClassName2;
          if (disabledTabClassName2) props2.disabledClassName = disabledTabClassName2;
          listIndex++;
          return (0, import_react2.cloneElement)(tab, props2);
        }) });
      } else if (isTabPanel(child)) {
        const props2 = { id: tabIds.current[index], selected: selectedIndex2 === index };
        if (forceRenderTabPanel2) props2.forceRender = forceRenderTabPanel2;
        if (selectedTabPanelClassName2) props2.selectedClassName = selectedTabPanelClassName2;
        index++;
